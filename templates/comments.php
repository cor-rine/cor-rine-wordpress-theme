    ...
    <nav>
      <ul class="pager">
        <?php if (get_previous_comments_link()) : ?>
          <li class="previous"><?php previous_comments_link(__('Older', 'roots')); ?></li>
        <?php endif; ?>
        <?php if (get_next_comments_link()) : ?>
          <li class="next"><?php next_comments_link(__('Newer', 'roots')); ?></li>
        <?php endif; ?>
      </ul>
    </nav>
    <?php endif; ?>
...
<?php if (comments_open()) : ?>
  <section id="respond">
    <h3><?php comment_form_title(__('Say Something', 'roots'), __('Leave a Reply to %s', 'roots')); ?></h3>
